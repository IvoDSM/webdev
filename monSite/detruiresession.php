...
<?php
  ...
  {
    echo '<div class="alert alert-danger" role="alert">Bonjour <b>'.$_SESSION['prenom'].' '.$_SESSION['nom'].'</b>, votre session a été détruite.</div>';
    // La session existe, on la détruit
    session_destroy();
  }
  else
  {
    echo '<div class="alert alert-warning" role="alert">Vous n\'avez pas crée de session.</div>';
  }
?>
</div>
